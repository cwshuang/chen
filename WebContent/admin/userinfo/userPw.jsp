			...
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				...
				<tr bgcolor="#FFFFFF">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="text" value="${sessionScope.admin}" id="username" name="username" size="20" />
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="text"  value="${sessionScope.userpw}"size="22"/>
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="text" id="userpw" name="userpw" size="22"/>
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
